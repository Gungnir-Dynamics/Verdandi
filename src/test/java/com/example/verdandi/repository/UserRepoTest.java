...
class UserRepoTest {
    ...
    @Test
    void findRoleIdByName() {

        int adminRoleId = userRepo.findRoleIdByName("admin");
        int userRoleId = userRepo.findRoleIdByName("user");

        assertThat(adminRoleId).isEqualTo(1);
        assertThat(userRoleId).isEqualTo(2);
